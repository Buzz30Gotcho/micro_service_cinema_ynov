    ...
    <div class="w-full max-w-md">
      ...
      >
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div
            v-if="success"
            class="p-3 bg-green-900/20 border border-green-500/30 rounded text-green-400 text-sm"
          >
            ✅ Si un compte avec cet email existe, un lien de réinitialisation a
            été envoyé.
          </div>
          ...
          <div
            v-if="error"
            class="p-3 bg-red-900/20 border border-red-500/30 rounded text-red-400 text-sm"
          >
            ⚠️ {{ error }}
          </div>
